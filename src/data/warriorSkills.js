...
export const WARRIOR_SKILLS = {
  ...
  leapStrike: {
    id: 'leapStrike',
    name: '跳斩',
    description: '跳向目标区域，落地造成{dmg}%范围伤害',
    icon: '⬆️',
    resource: 'rage',
    baseCost: 30,
    baseCooldown: 10000,
    ...
    requiredLevel: 7,
    category: 'active',
    phases: { startup: 150, active: 350, recovery: 250 },
    effect: {
      type: 'dash',
      distance: 140,
      speed: 450,
      ...
      knockback: 70,
      cameraShake: { intensity: 7, duration: 130 },
      isLeap: true
    }
  },
...
export function getSkillDescription(skillId, level) {
  ...
  if (eff.modifiers) {
    ...
    if (eff.modifiers.lifesteal) desc = desc.replace('{lifesteal}', Math.round(eff.modifiers.lifesteal * 100));
